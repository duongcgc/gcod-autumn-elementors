...
class Widget_Photo_Slider extends Widget_Base {

	// 1. Config settings
	private $settings = [
		'name'	=> 'photo-slider',
		'title'	=> 'GCO Photo Slider',
		'icon'	=> 'eion-post-list',
	];
...
\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Widget_Photo_Slider() );
